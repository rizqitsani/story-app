package com.rizqitsani.storyapp.data.local
...
import com.rizqitsani.storyapp.data.database.RemoteKeys
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        return try {
            val responseData = apiService.getPagedStories(token, page, state.config.pageSize)
            val stories: List<Story> = responseData.listStory.map {
